...
class UserController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Modules/Users/Admin/Index', [
            'users' => $users,
    ...
    public function create()
    {
        ...
        return Inertia::render('Modules/Users/Admin/Create', [
            'cargos' => $cargos,
            'roles' => $roles,
    ...
    public function store(Request $request, AvatarService $avatarService)
    {
        ...
        $rules = [
            ...
            'cargo_id' => ['nullable', function ($attribute, $value, $fail) {
                if ($value && $value !== 'none' && !\Modules\Elecciones\Models\Cargo::find($value)) {
    ...
    public function edit(User $usuario)
    {
        ...
        return Inertia::render('Modules/Users/Admin/Edit', [
            'user' => $usuario,
            'cargos' => $cargos,
            'roles' => $roles,
            'canAssignRoles' => auth()->user()->can('users.assign_roles'),
