...
use Modules\Core\Services\GlobalSettingsService;
...
class GlobalSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('>>> \Modules\Core\Services\GlobalSettingsService::setLoginType(\Modules\Core\Enums\LoginType::DOCUMENTO);');
    }
}
