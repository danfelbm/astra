...
class UpdateAsambleaRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('asambleas.edit');
    }
    ...
    /**
     * Obtener los datos validados listos para usar.
     */
    ...
    /**
     * Verificar si se puede iniciar la asamblea.
     */
    public function canStartAsamblea(): bool
    {
