...
use Modules\Asamblea\Http\Requests\User\MarcarAsistenciaParticipanteRequest;
...
use Modules\Asamblea\Services\AsambleaPublicService;
...
class AsambleaPublicController extends UserController
{
    ...
    public function index(Request $request, AsambleaRepository $repository): Response
    {
        ...
        return Inertia::render('Modules/Asamblea/User/Index', [
            'asambleas' => $asambleas,
    ...
    public function show(Asamblea $asamblea, AsambleaPublicService $asambleaPublicService): Response
    {
        ...
        return Inertia::render('Modules/Asamblea/User/Show', [
