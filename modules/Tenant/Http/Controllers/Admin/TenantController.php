...
namespace Modules\Tenant\Http\Controllers\Admin;
...
class TenantController extends AdminController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Modules/Tenant/Admin/Tenants/Index', [
            'tenants' => $tenants,
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Modules/Tenant/Admin/Tenants/Create', [
            'subscriptionPlans' => [
                'basic' => 'Plan Básico',
    ...
    public function edit(Tenant $tenant): Response
    {
        ...
        return Inertia::render('Modules/Tenant/Admin/Tenants/Edit', [
            'tenant' => $tenant,
            'subscriptionPlans' => [
                'basic' => 'Plan Básico',
                'professional' => 'Plan Profesional',
