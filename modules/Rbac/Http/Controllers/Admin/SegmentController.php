...
class SegmentController extends AdminController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Modules/Rbac/Admin/Segments/Index', [
            'segments' => $segments,
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Modules/Rbac/Admin/Segments/Create', [
            'roles' => Role::all(),
    ...
    public function show(Segment $segment): Response
    {
        ...
        return Inertia::render('Modules/Rbac/Admin/Segments/Show', [
            'segment' => $segment,
    ...
    public function edit(Segment $segment): Response
    {
        ...
        return Inertia::render('Modules/Rbac/Admin/Segments/Edit', [
            'segment' => $segment,
            'roles' => Role::all(),
            'filterFieldsConfig' => $this->getUserFilterFieldsConfig(),
            'modelTypes' => $this->getAvailableModelTypes(),
    ...
    protected function getFilterFieldsConfig(): array
    {
        return [
            ...
            [
                ...
                'type' => 'select',
                'options' => [
                    ['value' => 'Modules\Core\Models\User', 'label' => 'Usuarios'],
                ],
            ],
            [
                'name' => 'is_dynamic',
    ...
    {
        return [
            'Modules\Core\Models\User' => 'Usuarios',
