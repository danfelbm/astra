...
class PostulacionController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Modules/Elecciones/Admin/Postulaciones/Index', [
    ...
    public function show(Postulacion $postulacion)
    {
        ...
        return Inertia::render('Modules/Elecciones/Admin/Postulaciones/Show', [
            'postulacion' => [
                'id' => $postulacion->id,
                'usuario' => $postulacion->user ? [
                    'id' => $postulacion->user->id,
            ...
            'canRevisar' => auth()->user()->can('postulaciones.revisar'),
            'canAprobar' => auth()->user()->can('postulaciones.aprobar'),
            'canRechazar' => auth()->user()->can('postulaciones.rechazar'),
        ]);
    }
    ...
    public function cambiarEstado(Request $request, Postulacion $postulacion)
    {
        ...
        if ($nuevoEstado === 'en_revision') {
            abort_unless(auth()->user()->can('postulaciones.revisar'), 403, 'No tienes permisos para revisar postulaciones');
        } elseif ($nuevoEstado === 'aceptada') {
            abort_unless(auth()->user()->can('postulaciones.aprobar'), 403, 'No tienes permisos para aprobar postulaciones');
        } elseif ($nuevoEstado === 'rechazada') {
            abort_unless(auth()->user()->can('postulaciones.rechazar'), 403, 'No tienes permisos para rechazar postulaciones');
        } else {
            abort_unless(auth()->user()->can('postulaciones.revisar'), 403, 'No tienes permisos para cambiar el estado de postulaciones');
        }
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('postulaciones.view'), 403, 'No tienes permisos para ver estadísticas de postulaciones');
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('postulaciones.view'), 403, 'No tienes permisos para ver postulaciones');
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('postulaciones.export'), 403, 'No tienes permisos para exportar postulaciones');
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('postulaciones.view'), 403, 'No tienes permisos para ver reportes de postulaciones');
        ...
        return Inertia::render('Modules/Elecciones/Admin/Postulaciones/Reportes', [
