...
class CargoController extends AdminController
{
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('cargos.view'), 403, 'No tienes permisos para ver cargos');
        ...
        return Inertia::render('Modules/Elecciones/Admin/Cargos/Index', [
            'cargos' => $cargos,
            ...
            'canCreate' => auth()->user()->can('cargos.create'),
            'canEdit' => auth()->user()->can('cargos.edit'),
            'canDelete' => auth()->user()->can('cargos.delete'),
        ]);
    }
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('cargos.create'), 403, 'No tienes permisos para crear cargos');
        ...
        return Inertia::render('Modules/Elecciones/Admin/Cargos/Form', [
            'cargo' => null,
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('cargos.edit'), 403, 'No tienes permisos para editar cargos');
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('cargos.delete'), 403, 'No tienes permisos para eliminar cargos');
