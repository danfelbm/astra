...
class ConvocatoriaController extends AdminController
{
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('convocatorias.view'), 403, 'No tienes permisos para ver convocatorias');
        ...
        return Inertia::render('Modules/Elecciones/Admin/Convocatorias/Index', [
            ...
            'canCreate' => auth()->user()->can('convocatorias.create'),
            'canEdit' => auth()->user()->can('convocatorias.edit'),
            'canDelete' => auth()->user()->can('convocatorias.delete'),
        ]);
    }
    ...
    public function getFilterFieldsConfig(): array
    {
        ...
        $territorios = Territorio::all()->map(fn($t) => [
            'value' => $t->id,
            'label' => $t->nombre
        ]);
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('convocatorias.create'), 403, 'No tienes permisos para crear convocatorias');
        
        return Inertia::render('Modules/Elecciones/Admin/Convocatorias/Form', [
            'convocatoria' => null,
        ]);
    }
    ...
    public function show(Convocatoria $convocatoria): Response
    {
        ...
        return Inertia::render('Modules/Elecciones/Admin/Convocatorias/Show', [
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('convocatorias.edit'), 403, 'No tienes permisos para editar convocatorias');
    ...
    {
        // Verificar permisos
        abort_unless(auth()->user()->can('convocatorias.delete'), 403, 'No tienes permisos para eliminar convocatorias');
