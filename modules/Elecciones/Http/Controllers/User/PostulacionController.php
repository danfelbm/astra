...
class PostulacionController extends UserController
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Modules/Elecciones/User/Postulaciones/Index', [
    ...
    public function show(Convocatoria $convocatoria)
    {
        ...
        if (!$postulacionExistente && !$convocatoria->esDisponibleParaUsuario($usuario->id)) {
            return redirect()
                ->route('user.postulaciones.index')
        ...
        return Inertia::render('Modules/Elecciones/User/Postulaciones/Form', [
            'convocatoria' => [
                'id' => $convocatoria->id,
                'nombre' => $convocatoria->nombre,
                'descripcion' => $convocatoria->descripcion,
