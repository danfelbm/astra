...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from "@modules/Core/Resources/js/components/ui/dialog";
import { Skeleton } from "@modules/Core/Resources/js/components/ui/skeleton";
import { type CandidaturaHistorial, type HistorialPaginado } from '@modules/Core/Resources/js/types';
