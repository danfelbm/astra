...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, DialogDescription, DialogFooter } from "@modules/Core/Resources/js/components/ui/dialog";
...
import { stripHtml } from '@modules/Core/Resources/js/utils/htmlHelpers';
