...
import ConvocatoriaSelector from "@modules/Core/Resources/js/components/forms/ConvocatoriaSelector.vue";
import ConvocatoriaSeleccionada from "@modules/Core/Resources/js/components/forms/ConvocatoriaSeleccionada.vue";
import DatePickerField from "@modules/Core/Resources/js/components/forms/DatePickerField.vue";
import DisclaimerField from "@modules/Core/Resources/js/components/forms/DisclaimerField.vue";
import RepeaterField from "@modules/Core/Resources/js/components/forms/RepeaterField.vue";
...
import { useConditionalFields } from "@modules/Core/Resources/js/composables/useConditionalFields";
...
const {
    ...
    url: '/miembro/candidaturas/autosave',
...
const handleSubmit = async () => {
    ...
    if (props.is_editing) {
        form.put(`/miembro/candidaturas/${props.candidatura!.id}`, {
            onSuccess: () => {
        ...
        form.post('/miembro/candidaturas', {
            onSuccess: () => {
    ...
    <UserLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 pb-24">
            ...
            <div class="flex items-center justify-between">
                ...
                <Button variant="outline" @click="router.visit('/miembro/candidaturas')">
