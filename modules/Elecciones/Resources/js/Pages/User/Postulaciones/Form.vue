...
import DynamicFormRenderer from "@modules/Core/Resources/js/components/forms/DynamicFormRenderer.vue";
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: `/miembro/convocatorias/${props.convocatoria.id}`,
    },
];
...
const guardarBorrador = () => {
    ...
    form.post(`/miembro/convocatorias/${props.convocatoria.id}/postular`, {
        preserveScroll: true,
    });
};
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <div class="flex items-center gap-2">
                    <Button variant="ghost" size="sm" @click="router.get('/miembro/postulaciones')">
