...
const puedeEditar = computed(() => {
    return props.evidencia.estado === 'pendiente' &&
           props.evidencia.user_id === page.props.auth?.user?.id;
});
...
const confirmarEliminacion = () => {
    if (confirm('¿Estás seguro de que deseas eliminar esta evidencia? Esta acción no se puede deshacer.')) {
        router.delete(route('user.mis-contratos.evidencias.destroy', [props.contrato.id, props.evidencia.id]));
    }
};
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h2 class="text-3xl font-bold tracking-tight">Ver Evidencia</h2>
                ...
                <div class="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            ...
                            <Button
                                :href="route('user.mis-obligaciones.show', evidencia.obligacion.id)"
                                :as="Link"
                                variant="outline"
                                size="sm"
                            >
