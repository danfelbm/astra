...
interface FormField {
    id: string;
    type: 'text' | 'textarea' | 'select' | 'radio' | 'checkbox' | 'convocatoria' | 'perfil_candidatura';
    title: string;
    description?: string;
    required: boolean;
    options?: string[];
...
const formatRespuesta = (field: FormField, valor: any) => {
    // Para campos de tipo convocatoria o perfil_candidatura, null significa "Voto en blanco"
    if (field.type === 'convocatoria' || field.type === 'perfil_candidatura') {
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <Badge variant="secondary" class="ml-4">
                                    {{ field.type === 'text' ? 'Texto' : 
                                       ...
                                       field.type === 'checkbox' ? 'Múltiple' : 
                                       field.type === 'convocatoria' ? 'Convocatoria' :
                                       field.type === 'perfil_candidatura' ? 'Candidatura' : field.type }}
                                </Badge>
                            </div>
