...
// Usar la ruta de redirección o dashboard por defecto
const dashboardRoute = props.redirectRoute || 'dashboard';
</script>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    ...
                    <!-- No registro público - solo login OTP -->
                </template>
            </nav>
        </header>
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Plataforma de postulaciones</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Para poder acceder debes ser militante registrado, y tener acceso a tu correo electrónico.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Lee los
                                <a
                                    href="https://www.colombiahumana.co/inscripcion-precandidatos"
                                    target="_blank"
                ...
                <div
                    class="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#28354c] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none flex items-center justify-center"
                >
                    <!-- Logo Colombia Humana -->
                    <img 
                        src="/logoch.png" 
                        alt="Colombia Humana"
                        class="z-10 w-64 h-64 object-contain"
                    />
