...
// Obtener los IDs de roles actuales del usuario
...
const form = useForm({
    ...
    role_ids: currentRoleIds, // Cambiar a array para múltiples roles
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Mostrar roles actuales cuando no tiene permisos para cambiarlos -->
                            <div v-else>
                                <Label>Roles actuales</Label>
                                <div class="p-3 bg-muted rounded-md">
                                    <div v-if="user.roles && user.roles.length > 0" class="space-y-1">
                                        <p v-for="role in user.roles" :key="role.id" class="text-sm font-medium">
