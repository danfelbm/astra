...
class AsambleaPublicParticipantsController extends Controller
{
    ...
    public function show(Request $request, Asamblea $asamblea): Response
    {
        ...
        if ($asamblea->public_participants_mode === 'list') {
            return Inertia::render('Public/Asambleas/ParticipantsList', [
                'asamblea' => $asambleaData,
                'filterFieldsConfig' => $this->getPublicFilterFieldsConfig(),
            ]);
        } else {
            return Inertia::render('Public/Asambleas/ParticipantsSearch', [
                'asamblea' => $asambleaData,
            ]);
        }
    }
