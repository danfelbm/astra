...
class FormularioPublicController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $categorias = FormularioCategoria::whereHas('formularios', function ($q) {
        ...
        return Inertia::render('User/Formularios/Index', [
    ...
    public function show($slug): Response
    {
        ...
        if (!$formulario->estaDisponible()) {
            return Inertia::render('Guest/Formularios/NoDisponible', [
        ...
        if (!$formulario->puedeSerLlenadoPor($usuario)) {
            ...
            return Inertia::render('Guest/Formularios/SinAcceso', [
        ...
        if ($usuario) {
            ...
            if ($yaRespondido && $formulario->limite_por_usuario <= 1) {
                return Inertia::render('Guest/Formularios/YaRespondido', [
    ...
    public function success($slug): Response
    {
        ...
        return Inertia::render('Guest/Formularios/Success', [
            'formulario' => [
                'titulo' => $formulario->titulo,
                'mensaje_confirmacion' => $formulario->mensaje_confirmacion,
            ],
