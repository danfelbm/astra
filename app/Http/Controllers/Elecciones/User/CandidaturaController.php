...
class CandidaturaController extends UserController
{
    ...
    public function index()
    {
        ...
        if (!$config || !$config->tieneCampos()) {
            return Inertia::render('User/Candidaturas/NoDisponible', [
        ...
        return Inertia::render('User/Candidaturas/Dashboard', [
    ...
    public function create()
    {
        ...
        if ($configuracionBloqueo['bloqueo_activo']) {
            ...
            return Inertia::render('User/Candidaturas/Bloqueado', [
                'titulo' => $configuracionBloqueo['bloqueo_titulo'],
                'mensaje' => $configuracionBloqueo['bloqueo_mensaje'],
                'tipo' => 'crear',
            ]);
        ...
        return Inertia::render('User/Candidaturas/Form', [
            'candidatura' => null,
        ...
        try {
            ...
            if ($convocatoria) {
                ...
                if (!Postulacion::usuarioTienePostulacion($usuario->id, $convocatoria->id)) {
                    ...
                    \App\Models\Elecciones\PostulacionHistorial::crearRegistro(
                        $postulacion,
    ...
    public function show(Candidatura $candidatura)
    {
        ...
        return Inertia::render('User/Candidaturas/Show', [
            'candidatura' => [
                'id' => $candidatura->id,
        ...
        if ($estadoFinal === Candidatura::ESTADO_PENDIENTE && $nuevoEstado === Candidatura::ESTADO_PENDIENTE) {
            ...
            if (!$postulacionExistente) {
                ...
                if ($convocatoriaId) {
                    ...
                    $convocatoria = \App\Models\Elecciones\Convocatoria::find($convocatoriaId);
    ...
    private function validarFormularioDinamico(Request $request, array $campos)
    {
        ...
        $conditionalService = new \App\Services\Formularios\ConditionalFieldService();
