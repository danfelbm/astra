...
use App\Services\Core\CachedGlobalSettingsService as GlobalSettingsService;
...
class OTPAuthController extends Controller
{
    ...
    public function verifyOTP(Request $request): RedirectResponse
    {
        ...
        // Si no hay URL intended, usar la ruta preferida del usuario
        // Esto considera roles con redirect_after_login configurado o el tipo de acceso
